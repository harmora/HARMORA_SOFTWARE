            ...
            <form action="{{url('/factures/update', $facture->id)}}" method="POST" class="form-submit-event" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="company_name" name="company_name" value="{{ $facture->company_name }}" readonly>
                    </div>

                    <div class="mb-3 col-md-6">
                        <label for="address" class="form-label"><?= get_label('address', 'Address') ?><span class="asterisk">*</span></label>
                        <input class="form-control" type="text" id="address" name="address" placeholder="<?= get_label('please_enter_address', 'Please enter address') ?>" value="{{ old('address', $facture->address) }}" required>
                    </div>
                ...
                <div class="mt-4 text-end">
                    <button type="submit" class="btn btn-primary"><?= get_label('update_facture', 'Update Facture') ?></button>
                </div>
            </form>
        </div>
    </div>
