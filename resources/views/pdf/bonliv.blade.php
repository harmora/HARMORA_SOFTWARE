...
<html>
<head>
    <title>Bon livraision #{{ $commande->id }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="facture-container">
        ...
        <div class="facture-header">
            <h3>{{ get_label('bonliv', 'Bon livraision') }}</h3>
            <p style="color: black !important"><strong>{{ get_label('reference', 'Reference :') }} :</strong> {{"Bon_livraision_".$commande->reference_num}}</p>
        </div>
