            ...
            <form action="{{url('/settings/store_general')}}" class="form-submit-event" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <i class='bx bx-info-circle text-primary' data-bs-toggle="tooltip" data-bs-placement="top" title="<?= get_label('enable_disable_signup_info', 'If disabled, team member or client will not be able to create an account by themselves.') ?>"></i>
