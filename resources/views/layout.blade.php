...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('fullcalendarr/core/main.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('fullcalendarr/daygrid/main.css') }}">
...
<body>
    ...
    <script src="{{ asset('fullcalendarr/core/main.js') }}"></script>
    <script src="{{ asset('fullcalendarr/daygrid/main.js') }}"></script>
