            ...
            <form action="{{url('/payslips/store')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" id="working_days" name="working_days" step="0.5" min="0" placeholder="<?= get_label('please_enter_working_days', 'Please enter working days') ?>" value="{{ old('working_days') }}">
                        <span class="text-danger text-xs mt-1 error-message"></span>
                    </div>
                    <div class="mb-3 col-md-4">
