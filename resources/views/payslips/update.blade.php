            ...
            <form action="{{url('/payslips/update')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" id="working_days" name="working_days" min="0" step="0.5" placeholder="<?= get_label('please_enter_working_days', 'Please enter working days') ?>" value="{{ old('working_days', $payslip->working_days) }}">
                        <span class="text-danger text-xs mt-1 error-message"></span>
                    </div>
                    <div class="mb-3 col-md-4">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <span class="text-danger text-xs mt-1 error-message"></span>
                        <div class="mt-2">
                            <a href="javascript:void(0);" class="openCreatePmModal"><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="<?= get_label('create_payment_method', 'Create payment method') ?>"><i class="bx bx-plus"></i></button></a>
                    ...
                    <div class="mb-3 col-md-5">
                        ...
                        <div class="mt-2">
                            <a href="javascript:void(0);" class="openCreateAllowanceModal"><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title=" <?= get_label('create_allowance', 'Create allowance') ?>"><i class="bx bx-plus"></i></button></a>
                    ...
                    <div class="mb-3 col-md-7">
                        ...
                        <div class="mt-2">
                            <a href="javascript:void(0);" class="openCreateDeductionModal"><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title=" <?= get_label('create_deduction', 'Create deduction') ?>"><i class="bx bx-plus"></i></button></a>
