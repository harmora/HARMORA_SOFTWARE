...
@endphp
@if (isset($commandes) && $commandes > 0 || (isset($emptyState) && $emptyState == 0))
<div class="<?= $flag == 1 ? 'card ' : '' ?>mt-2">
    @endif
    @if ($flag == 1 && (isset($commandes) && $commandes > 0 || (isset($emptyState) && $emptyState == 0)))
    <div class="card-body">
        @endif
        {{$slot}}
        @if (isset($commandes) && $commandes > 0 || (isset($emptyState) && $emptyState == 0))
        <div class="row">
            ...
            @isset($projects)
            <div class="col-md-4 mb-3">
                <select class="form-control js-example-basic-multiple" id="commandes_project_filter" multiple="multiple" data-placeholder="<?= get_label('select_projects', 'Select Projects') ?>">
