    ...
    public function destroy($id)
    {
        if ($this->workspace->id != $id) {
            ...
            if ($workspace->is_primary == 0) {
                ...
                return response()->json(['error' => true, 'message' => 'Primary workspace couldn\'t deleted.']);
            }
        } else {
            return response()->json(['error' => true, 'message' => 'Current workspace couldn\'t deleted. please switch the workspace first.']);
        }
    }
