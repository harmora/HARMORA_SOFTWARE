...
return new class extends Migration
{
    ...
    {
        Schema::create('bon_livraisions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('invoice_id')->nullable(); // Foreign key for users table
    ...
    {
        Schema::dropIfExists('bon_livraisions');
    }
};
